...
function VideoComponent( _video )
{
    ...
    this.unmuteVideo = function( _isUser )
    {
        ...
        console.log( "VIDEO COMPONENT UNMUTE VIDEO" );
    ...
    function videoPlaying( e )
    {
        ...
        console.log( "VIDEO COMPONENT: VIDEO PLAYING" );
    ...
    function videoPaused( e )
    {
        ...
        console.log( "VIDEO COMPONENT: VIDEO PAUSED" );
    ...
    {
//        console.log( "SEND VIDEO EVENT :: ", _event );
