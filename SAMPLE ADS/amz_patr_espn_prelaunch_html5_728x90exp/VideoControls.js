...
VideoControls.prototype.init = function()
{
    ...
    console.log( "VIDEO CONTROLS INIT CALLED :: ", this.audioBtn, this.slider, this.progressDiv );
...
//    if( _event.type != Constants.VIDEO_UPDATED ) console.log( "CONTROLS VIDEO UPDATED :: " + _event.type );
